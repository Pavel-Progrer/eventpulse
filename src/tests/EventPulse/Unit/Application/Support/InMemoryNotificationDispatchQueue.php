 ...
 *
 * Mirrors `InMemoryNotificationRepository`'s philosophy: a real implementation
 * of the port that records what would have happened, instead of a mocking
 * framework's expectation set. Real implementations of test doubles compose
 * with handler logic correctly even when behaviour evolves.
 *
